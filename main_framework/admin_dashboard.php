    ...
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
        <div class="container-fluid">
            <a class="navbar-brand" href="admin_details.php" data-bs-toggle="tooltip" title="ADMIN DETAILS">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" style="width:30px;"
                    fill="currentColor">
            ...
            <h3 class="container-fluid  text-white" style="text-align: center">Hello <?php echo $data[1];?> You are now
                an ADMIN..</h3>
            <div class="d-flex">
                <a class="navbar-brand" href="../login_system/backend/_logout.php" data-bs-toggle="tooltip"
                    title="LOGOUT">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24"
                        style="width:30px;" stroke="currentColor" strokeWidth={2}>
